...
import com.afei.camerademo.surfaceview.AutoFitTextureView;
...
public class CameraControl {
    ...
    private static class ClassHolder {
        static CameraControl mInstance = new CameraControl();

    }

    public static CameraControl getInstance(Activity activity) {
        mActivity = activity;
